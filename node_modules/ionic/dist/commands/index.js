...
class IonicNamespace extends namespace_1.Namespace {
    constructor() {
        ...
        this.namespaces = new namespace_1.NamespaceMap([
            ['config', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { ConfigNamespace } = yield Promise.resolve().then(function () { return require('./config/index'); }); return new ConfigNamespace(); })],
            ['cordova', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { CordovaNamespace } = yield Promise.resolve().then(function () { return require('./cordova/index'); }); return new CordovaNamespace(); })],
            ['git', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { GitNamespace } = yield Promise.resolve().then(function () { return require('./git/index'); }); return new GitNamespace(); })],
            ['ssh', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { SSHNamespace } = yield Promise.resolve().then(function () { return require('./ssh/index'); }); return new SSHNamespace(); })],
            ['package', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { PackageNamespace } = yield Promise.resolve().then(function () { return require('./package/index'); }); return new PackageNamespace(); })],
            ['monitoring', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { MonitoringNamespace } = yield Promise.resolve().then(function () { return require('./monitoring/index'); }); return new MonitoringNamespace(); })],
            ['doctor', () => tslib_1.__awaiter(this, void 0, void 0, function* () { const { DoctorNamespace } = yield Promise.resolve().then(function () { return require('./doctor/index'); }); return new DoctorNamespace(); })],
        ]);
